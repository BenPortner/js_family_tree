    ...
    class D3DAGAdapter {
        constructor(data) {
            ...
            const layout = ji()
                .nodeSize([120, 120])
                .layering(Tn())
                .decross(this.customSugiyamaDecross)
                .coord(Ji());
