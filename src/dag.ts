...
export interface Node extends d3dag.MutGraphNode<PersonData | UnionData, undefined> {}

export interface Link extends d3dag.MutGraphLink<PersonData | UnionData, undefined> {}
...
export class D3DAGAdapter {
  ...
  private customSugiyamaDecross(layers: d3dag.SugiNode<PersonData | UnionData>[][]): void {
